...
class Program {
    ...
    public DefaultMutableTreeNode makeRoot() {
        rootNode.add(decpart.makeNode());
        rootNode.add(body.makeNode());
    	return rootNode;
    }
}
...
class Declarations extends ArrayList<Declaration> {
    ...
    DefaultMutableTreeNode node = new DefaultMutableTreeNode("Declarations : ");
	public DefaultMutableTreeNode makeNode() {
		for (int i = 0; i < size(); i++) {
			node.add(get(i).makeNode());
		}
		return node;
	}
...
// Declaration = Variable v; Type t
    ...
    DefaultMutableTreeNode node = new DefaultMutableTreeNode("Variable:");
	public DefaultMutableTreeNode makeNode() {
		DefaultMutableTreeNode tNode = new DefaultMutableTreeNode("Type: "+ t);
		DefaultMutableTreeNode vNode = new DefaultMutableTreeNode("Name: "+ v);
		node.add(tNode);
		node.add(vNode);
		return node;
	}
...
class Type {
	...
	public DefaultMutableTreeNode makeNode() {
	    DefaultMutableTreeNode node = new DefaultMutableTreeNode("Type: " + id);
		return node;
	}
}
...
class Assignment extends Statement {
	...
	public DefaultMutableTreeNode makeNode() {
		aNode.add(target.makeNode());
		aNode.add(source.makeNode());
		return aNode;
	}
...
class Variable extends Expression {
	...
	public DefaultMutableTreeNode makeNode() {
	    DefaultMutableTreeNode vNode = new DefaultMutableTreeNode("Variable : " + id);
		return vNode;
	}
